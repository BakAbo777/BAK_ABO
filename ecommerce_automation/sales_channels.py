...
CHANNEL_SPECS: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "priority": "primary",
        "purpose": "Evergreen visual search and collection discovery via 9 BKS collection boards.",
        "required": "PINTEREST_ACCESS_TOKEN",
        "status_key": "pinterest",
    },
    {
        "channel": "Amazon Merch on Demand",
        "type": "print on demand",
        "priority": "primary",
        "purpose": "Upload BKS designs for passive royalties via merch.amazon.com (not Seller Central).",
        "required": "AMAZON_MERCH_EMAIL",
        "status_key": "amazon_merch",
    },
    {
        "channel": "Amazon Marketplace",
        "type": "marketplace",
        "priority": "future",
        "purpose": "Full Seller Central marketplace extension after Shopify catalog stability.",
    ...
    },
    {
        ...
        "type": "community",
        "priority": "primary",
        "purpose": "Drop announcements, restock alerts and direct community messages.",
        "required": "TELEGRAM_BOT_TOKEN;TELEGRAM_CHAT_ID",
        "status_key": "telegram_bot",
    },
    {
        "channel": "Etsy",
        "type": "marketplace",
...
def _statuses(settings: Any) -> dict[str, str]:
    ...
    return {
        ...
        "pinterest": "active" if (settings.pinterest_access_token or settings.pinterest_business_id) else "planned",
        "amazon_merch": "active" if settings.amazon_merch_email else "planned",
        ...
        "telegram_bot": "active" if (settings.telegram_bot_token and settings.telegram_chat_id) else ("partial" if settings.telegram_bot_token else "planned"),
