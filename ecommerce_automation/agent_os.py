...
CONNECTORS: tuple[dict[str, Any], ...] = (
    ...
    {"name": "OpenAI", "domain": "AI", "stage": "active", "env": ("OPENAI_API_KEY",), "autonomy": "draft_only", "risk": "medium", "purpose": "Agent reasoning, copy, scripts and image prompts."},
    ...
    {"name": "Canva", "domain": "Creative", "stage": "optional", "env": ("CANVA_API_KEY",), "autonomy": "draft_only", "risk": "low", "purpose": "Campaign creatives and social resizes."},
