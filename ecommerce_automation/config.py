...
class Settings:
    ...
    telegram_channel_id: str = _env("TELEGRAM_CHANNEL_ID", default="")
    ...
    amazon_merch_email: str = _env("AMAZON_MERCH_EMAIL", default="")
    amazon_merch_tier: str = _env("AMAZON_MERCH_TIER", default="Standard")
