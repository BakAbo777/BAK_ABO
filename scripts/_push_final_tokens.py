"""Deploy final token-system files: tokens + member + responsive."""
...
files = [
    ("assets/bks-tokens.css",    ROOT / "04_TEMA_SHOPIFY/assets/bks-tokens.css"),
    ("assets/bks-member.css",    ROOT / "04_TEMA_SHOPIFY/assets/bks-member.css"),
