...
files = [
    ("assets/bks-dynamic-theme.css", ROOT / "04_TEMA_SHOPIFY/assets/bks-dynamic-theme.css"),
    ("assets/bks-piano-hero.css",     ROOT / "04_TEMA_SHOPIFY/assets/bks-piano-hero.css"),
]
ok = 0
