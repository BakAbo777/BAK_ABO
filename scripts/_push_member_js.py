"""Push bks-member.js and bks-member.css to live Shopify theme."""
...
FILES = ["assets/bks-member.js", "assets/bks-member.css"]

for key in FILES:
    body = (SRC / key).read_text(encoding="utf-8")
