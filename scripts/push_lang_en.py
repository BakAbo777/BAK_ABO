"""Push: language fix — translate all Italian UI text to English.

Files pushed (from 04_TEMA_SHOPIFY/):
  - templates/page.bks-about-bakabo.json
  - templates/page.bks-contact.json
  - sections/bks-contact.liquid
  - sections/bks-members-login.liquid
  - sections/bks-policy.liquid
...
print("=== Push: Language Fix (EN) ===\n")
ok = err = 0
for key in FILES:
    local = THEME_DIR / key
    if not local.exists():
        print(f"  SKIP  {key}  (file not found locally)")
        continue
