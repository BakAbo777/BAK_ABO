...
- `it` Italiano: chiaro, premium, rassicurante (primary market)
- `en` English: clear, creative, trust-first (international baseline)
- `es` Espanol: directo, visual, transparente (EU/social expansion)
- `fr` Francais: sobre, creatif, fiable (EU/social expansion)
- `de` Deutsch: klar, sachlich, verlaesslich (EU/trust market)
