...
- `bakabo-brand` - expected file `docs/bakabo-brand_SKILL.md`
- `bakabo-design-system` - expected file `docs/bakabo-design-system_SKILL.md`
- `bakabo-growth` - expected file `docs/bakabo-growth_SKILL.md`
- `bakabo-pages-design` - expected file `docs/bakabo-pages-design_SKILL.md`
- `bakabo-product-copy` - expected file `docs/bakabo-product-copy_SKILL.md`
- `bakabo-shopify-ops` - expected file `docs/bakabo-shopify-ops_SKILL.md`
- `bakabo-theme-build` - expected file `docs/bakabo-theme-build_SKILL.md`
